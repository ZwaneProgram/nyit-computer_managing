...
- [ ] **3. Deploy to the Contabo VPS** — IN PROGRESS (2026-06-03). **Full runbook is in `DEPLOY.md`** (repo root). Repo-side prep is DONE; the VPS steps are the user's to run (Claude can't SSH in).
